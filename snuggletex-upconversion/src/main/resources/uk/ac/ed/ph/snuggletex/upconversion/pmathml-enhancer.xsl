...
mathematical expressions, resulting in hopefully richer Presentation
MathML that is more amenable to further conversion (e.g. to Content
MathML).

This is the first step in the semantic enrichment process.
